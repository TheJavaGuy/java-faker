...
public class DateAndTimeTest extends AbstractFakerTest {
    ...
    public void testFutureDateWithMinimum(){
        for (int i = 0; i < 1000; i++) {
            ...
            assertThat(future.getTime()).as("future date under minimum range").isGreaterThan(now.getTime() + 3999);
        }
    }
    ...
    public void testPastDateWithMinimum(){
        for (int i = 0; i < 1000; i++) {
            ...
            assertThat(past.getTime()).as("past date under minimum range").isLessThan(now.getTime() - 3999);
        }
    }
    ...
    public void testBirthday() {
        ...
        for (int i = 0; i < 5000; i++) {
            ...
            assertThat(birthday.getTime()).as("birthday is before lower bound").isGreaterThanOrEqualTo(from);
        }
    }
