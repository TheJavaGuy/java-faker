...
public class DuneTest extends AbstractFakerTest {
  ...
  public void randomQuote() {
    assertThat(faker.dune().quote(faker.options().option(Dune.Quote.class))).matches("\\P{Cc}+");
  }
  ...
  public void randomSaying() {
    assertThat(faker.dune().saying(faker.options().option(Dune.Saying.class))).matches("\\P{Cc}+");
  }
}
