...
public class Name {
  ...
  /**
   * A multipart name composed of an optional prefix, a firstname and a lastname or other possible
   * variances based on locale. Examples:
   *
   * <ul>
   *   <li>James Jones Jr.
   *   <li>Julie Johnson
  ...
  /**
   * A multipart name composed of an optional prefix, a given and family name, another 'firstname'
   * for the middle name and an optional suffix such as Jr. Examples:
   *
   * <ul>
   *   <li>Mrs. Ella Geraldine Fitzgerald
   *   <li>Jason Tom Sawyer Jr.
   *   <li>Helen Jessica Troy
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>(template) {descriptor} {level} {job}
   *   <li>Lead Solutions Specialist
   *   <li>National Marketing Manager
   *   <li>Central Response Liaison
   * </ul>
   *
  ...
  /**
   * A lowercase username composed of the first_name and last_name joined with a '.'. Some examples
   * are:
   *
   * <ul>
   *   <li>(template) {@link #firstName()}.{@link #lastName()}
   *   <li>jim.jones
   *   <li>jason.leigh
   *   <li>tracy.jordan
   * </ul>
