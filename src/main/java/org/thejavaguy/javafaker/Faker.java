...
/**
 * Provides utility methods for generating fake strings, such as names, phone numbers, addresses.
...
public class Faker {
   ...
   *   <li>#{regexify '\\.\\*\\?\\+'}
   *   <li>#{bothify '????','false'}
   *   <li>#{Name.first_name} #{Name.first_name} #{Name.last_name}
   *   <li>#{number.number_between '1','10'}
   * </ul>
   *
