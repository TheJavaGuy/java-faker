...
public class Shipping {
  ...
  public String trackingNumber() {
    ...
    switch (choice) {
      case 0:
        return trackingNumberUps();
      case 1:
        return trackingNumberFedEx();
      case 2:
        return trackingNumberUsps();
      default:
        return trackingNumberDhl();
    }
  }
  ...
  public String facilityLocation() {
    ...
    String[] types = {
      "Distribution Center", "Hub", "Sort Facility", "Processing Center", "Delivery Station"
    };
    ...
    switch (status) {
      ...
      case "attempted_delivery":
        return "Delivery attempted - "
            + faker.fakeValuesService().fetchString("shipping.exception_types");
      default:
