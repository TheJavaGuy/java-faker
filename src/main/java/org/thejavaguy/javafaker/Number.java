...
public class Number {
  ...
  /**
   * Return a number between <em>min</em> and <em>max</em>. If min == max, then min is returned. So
   * numberBetween(2,2) will yield 2 even though it doesn't make sense.
   *
   * @param min inclusive
   ...
   * @param strict whether or not the generated value should have exactly <code>numberOfDigits
   *     </code>
   */
