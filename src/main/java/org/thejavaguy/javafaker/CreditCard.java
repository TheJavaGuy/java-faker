...
/**
 * Generates realistic credit card fake data including numbers, expiration dates, CVVs, and
 * cardholder information.
 *
 * <p>All generated card numbers pass Luhn validation but are not real card numbers and should only
...
public class CreditCard {
  ...
  /**
   * Generates a random credit card number from any supported type. The number includes a valid Luhn
   * check digit.
   *
  ...
  /**
   * Generates a credit card number for the specified type. The number includes a valid Luhn check
   * digit.
   *
  ...
  /**
   * Generates a CVV/CVC security code. Returns 4 digits for American Express, 3 digits for all
   * other types.
   *
  ...
  /**
   * Generates a CVV/CVC for the specified card type. American Express uses 4 digits; others use 3.
   *
   * @param type the credit card type
  ...
  /**
   * Generates a valid expiration date in MM/YY format. The date will be between 1 month and 5 years
   * in the future.
   *
  ...
  /**
   * Generates the last 4 digits of a card number. Useful for display/masking scenarios.
   *
